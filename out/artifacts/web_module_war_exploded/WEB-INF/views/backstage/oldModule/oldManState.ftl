<script src="${domainUrl}/assets/js/modules/oldModule/servicePeopleState.js"></script>

<div id="now-position">
    您当前所在的位置：<span>老人状态</span>
</div>
<div class="serve-banner">
    <an><input type="button" value="添加状态" data-toggle="modal" data-target="#myModal">
