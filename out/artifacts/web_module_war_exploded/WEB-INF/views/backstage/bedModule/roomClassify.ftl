<script src="${domainUrl}/assets/js/modules/bedModule/roomClassify.js"></script>
<div id="now-position">
    您当前所在的位置：<span>房间类别模块</span>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="add">
                    <tr>
                        <td>类别名称</td>
                        <td><input type="text" id="roomTypeName"><input type="text" id="classTid" style="display: none;"></td>
                    </tr>
                </table>
            </div>
