<script src="${domainUrl}/assets/js/modules/stockModule/stockClassify.js"></script>
<div id="now-position">
    您当前所在的位置：<span>库存类别</span>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="add">
                    <tr>
                        <td>类别名称</td>
                        <td><input type="text" id="stockTypeName"><input type="text" id="classTid"
