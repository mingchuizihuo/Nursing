...
public class GenerateController {
    ...
    public static void main(String[] args) {
        String[] fileNames = new String[]{
                "FixedAssetsType,固定资产类型,1",
                "FixedAssets,固定资产",
                "FixedAssetsLog,固定资产日志",
        ...
        for (String fileName:fileNames) {
            ...
            try {
                GenerateController.Generate(
                        "\\FixedAssets\\src\\test\\java\\ftl",
                        "controller.ftl",
                        fileName,
                        "\\FixedAssets\\src\\main\\java\\com\\idea\\nursing\\fixedassets\\web\\controller",

                        "com.idea.nursing.fixedassets.web.controller",
                        "com.idea.nursing.fixedassets.web.domain.pojo",
                        "com.idea.nursing.fixedassets.web.service"
//
                );
            } catch (IOException e) {
                e.printStackTrace();
