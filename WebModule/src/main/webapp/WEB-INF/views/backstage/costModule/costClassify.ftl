<script src="${domainUrl}/assets/js/modules/costModule/costClassify.js"></script>
<div id="now-position">
    您当前所在的位置：<span>费用类别</span>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="add">
                    <tr>
                        <td>类别名称</td>
                        <td><input type="text" id="costTypeName"><input type="text" id="classTid"
