...
<head>
    ...
    <script type="text/javascript" src="${domainUrl}/assets/js/mall/login/register.js"></script>
    <title>商家注册</title>
</head>
<script>
...
<div class="w">
    <div class="register-mail">
        <table id="one">
            ...
            <tr>
                <td></td>
                <td><input type="button" value="下一步" class="btn-none pull-left" id="one-btn">
                    <a href="${domainUrl}/rest/mall/login/login">
                        <input type="button" value="登录" class="pull-right btn">
                    </a>
                    <div class="clear">
                    </div></td>
                <td></td>
            ...
            <tr>
                <td></td>
                <#--<td><a href="${domainUrl}/rest/mall/login/register"id="qiehuanzhuce" >切换为个人注册</a></td>-->
                <td></td>
            </tr>
        </table>
