...
!function (e) {
    ...
    function l(e) {
        ...
        if (t && !m(e, M)) {
            ...
            C(i, function (i, n) {
                ...
                d && !P[d] ? (h.res && (l = {id: i, mod: d, res: h.res}, r.push(i), t.depRs.push(l)), s = t.depMkv[d], s || (s = {
                    id: h.mod,
                    absId: d,
                    hard: a > n
    ...
    var e = {
        ...
        markLine: {
            ...
            itemStyle: {normal: {borderWidth: 1.5, label: {show: !0, position: "end"}, lineStyle: {type: "dashed"}}, emphasis: {label: {show: !1}, lineStyle: {}}}
        },
    ...
    var e = {
        EVENT: {
            ...
            DROP: "drop",
            touchClickDelay: 300
        }, elementClassName: "zr-element", catchBrushException: !1, debugMode: 0, devicePixelRatio: Math.max(window.devicePixelRatio || 1, 1)
    };
    return e
    ...
    s.toolbox = {
        ...
        showTitle: !0,
        feature: {
            mark: {show: !1, title: {mark: "辅助线开关", markUndo: "删除辅助线", markClear: "清空辅助线"}, lineStyle: {width: 1, color: "#1e90ff", type: "dashed"}},
            dataZoom: {show: !1, title: {dataZoom: "区域缩放", dataZoomReset: "区域缩放后退"}},
            dataView: {show: !1, title: "数据视图", readOnly: !1, lang: ["数据视图", "关闭", "刷新"]},
            magicType: {
                show: !1,
                title: {line: "折线图切换", bar: "柱形图切换", stack: "堆积", tiled: "平铺", force: "力导向布局图切换", chord: "和弦图切换", pie: "饼图切换", funnel: "漏斗图切换"},
                type: []
            },
    ...
    return t.prototype = {
        type: s.COMPONENT_TYPE_TOOLBOX, _buildShape: function () {
            ...
            "image" != e.type ? this.zr.modShape(e.id, {hoverable: !1, clickable: !1, style: {strokeColor: this._disableColor}}) : this.zr.modShape(e.id, {
                hoverable: !1,
                clickable: !1,
                style: {opacity: .3}
            })
    ...
    t.prototype = {
        type: l.COMPONENT_TYPE_LEGEND, _buildShape: function () {
            ...
            var s, h = "#ccc" === a ? r : a, d = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {iconType: "legendicon" + o, x: e, y: t, width: i, height: n, color: a, strokeColor: a, lineWidth: 2},
    ...
    s.timeline = {
        ...
        checkpointStyle: {symbol: "auto", symbolSize: "auto", color: "auto", borderColor: "auto", borderWidth: "auto", label: {show: !1, textStyle: {color: "auto"}}},
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        var i = n.merge(this.options, {
            ...
            effectOption: {x: 0, y: this.canvasHeight / 2 - 30, width: this.canvasWidth, height: 5, brushType: "fill", timeInterval: 100}
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        ...
        for (var x = 0; 4 > x; x++)f.push(new r({
            highlightStyle: {x: c, y: m, r0: p, r: u, startAngle: _ - b, endAngle: _, brushType: "fill", color: U},
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        ...
        }), U = new s({highlightStyle: {r: Math.round(m.r / 6), brushType: "fill", color: m.colorIn}}), g = new o({
            highlightStyle: {
    ...
    var e = {
        ...
        tooltip: {
            ...
            axisPointer: {type: "line", lineStyle: {color: "#008acd"}, crossStyle: {color: "#008acd"}, shadowStyle: {color: "rgba(200,200,200,0.2)"}}
        },
        ...
        chord: {
            itemStyle: {
                normal: {borderWidth: 1, borderColor: "rgba(128, 128, 128, 0.5)", chordStyle: {lineStyle: {color: "rgba(128, 128, 128, 0.5)"}}},
                emphasis: {borderWidth: 1, borderColor: "rgba(128, 128, 128, 0.5)", chordStyle: {lineStyle: {color: "rgba(128, 128, 128, 0.5)"}}}
            }
        },
        gauge: {
    ...
    var e = {
        ...
        tooltip: {
            backgroundColor: "rgba(50,50,50,0.5)",
            axisPointer: {type: "line", lineStyle: {color: "#27727B", type: "dashed"}, crossStyle: {color: "#27727B"}, shadowStyle: {color: "rgba(200,200,200,0.3)"}}
        },
    ...
    return i.prototype = {
        setCalculable: function (e) {
            ...
            var x = this.getItemStyleColor(f.color, t, o, i), k = this.getItemStyleColor(y.color, t, o, i), v = U[0], L = U[1], w = new a({
                ...
                highlightStyle: {color: h.match("empty") ? m : k || x || c, strokeColor: y.borderColor || f.borderColor || k || x || c, lineWidth: _},
    ...
    function t(e, t, i, n) {
        ...
        "image" !== i.type ? (a = new h({
            ...
            draggable: !1,
            hoverable: !1
        }))) : a = new s({zlevel: n, style: i.style, draggable: !1, hoverable: !1}), o.clone(i, a), a.position = i.position, t.push(a), e.addShape(a);
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATAZOOM, _buildShape: function () {
            ...
            this.shapeList.push(new n({
                ...
                z: this.getZBase(),
                hoverable: !1,
                style: {x: this._location.x, y: this._location.y, width: e, height: t, color: this.zoomOption.backgroundColor}
            }));
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_AXIS_CATEGORY, _getReformedLabel: function (e) {
            ...
            if (i -= d || "undefined" == typeof d && this.option.boundaryGap ? 1 : 0, this.isHorizontal())for (var m, p = this.grid.getY(), u = this.grid.getYend(), V = 0; i > V; V += this._interval)(!h || h(V, t[V])) && (m = this.subPixelOptimize(this.getCoordByIndex(V) + c, r), e = {
                ...
                z: this.getZBase(),
                hoverable: !1,
                style: {xStart: m, yStart: p, xEnd: m, yEnd: u, strokeColor: s[V / this._interval % l], lineType: o, lineWidth: r}
                ...
                z: this.getZBase(),
                hoverable: !1,
                style: {xStart: g, yStart: U, xEnd: f, yEnd: U, strokeColor: s[V / this._interval % l], lineType: o, lineWidth: r}
            }, this.shapeList.push(new a(e)))
            ...
            if (n instanceof Array) {
                ...
                z: this.getZBase(),
                hoverable: !1,
                style: {x: this.grid.getX(), y: this.grid.getY(), width: this.grid.getWidth(), height: this.grid.getHeight(), color: n}
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_AXIS_VALUE, _buildShape: function () {
            ...
            if (t instanceof Array) {
                ...
                z: this.getZBase(),
                hoverable: !1,
                style: {x: this.grid.getX(), y: this.grid.getY(), width: this.grid.getWidth(), height: this.grid.getHeight(), color: t}
            }, this.shapeList.push(new o(e))
    ...
    var d = [{formatter: "hh : mm : ss", value: 1e3}, {formatter: "hh : mm : ss", value: 5e3}, {formatter: "hh : mm : ss", value: 1e4}, {
        formatter: "hh : mm : ss",
        value: 15e3
    }, {formatter: "hh : mm : ss", value: 3e4}, {formatter: "hh : mm\nMM - dd", value: 6e4}, {formatter: "hh : mm\nMM - dd", value: 3e5}, {
        formatter: "hh : mm\nMM - dd",
        value: 6e5
        ...
        formatter: "hh : mm\nMM - dd",
        value: 432e5
    }, {formatter: "MM - dd\nyyyy", value: 864e5}, {formatter: "week", value: 6048e5}, {formatter: "month", value: 26784e5}, {
        formatter: "quarter",
        value: 8208e6
    }, {formatter: "half-year", value: 16416e6}, {formatter: "year", value: 32832e6}];
    return {
        getAutoFormatter: e,
        getNewDate: h,
        format: i,
