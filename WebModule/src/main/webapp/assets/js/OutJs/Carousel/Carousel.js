...
(function($) {
	...
	$.fn.orbit = function(options) {
		...
		var dataCar = featured.getAttribute('data-car');
		var dataMove = featured.getAttribute('data-move')
		if(dataCar == null){
			dataCar = 5000;
		}
		if(dataMove == 0){
		...
		// alert(dataCar +"..."+ dataOut +"..."+ dataMove)
		var defaults = {
			animation: 'horizontal-push', 					// 滚动样式 fade, horizontal-slide, vertical-slide, horizontal-push
			animationSpeed: 600, 				// 切换速度
			timer: true, 						// 是否自动滚动
			advanceSpeed: dataCar, 				// 停留时间
			pauseOnHover: dataMove, 			// 鼠标悬停是否停止
