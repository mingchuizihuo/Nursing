    ...
    getAjax(url,false,getData,function (data) {
        ...
        for (var i = 0; i < num1; i++) {
            html += '<li style="border-top:1px solid #dddddd"><a href="#" class="one">' +
                '' + data.aaData[0][i].meterialTypeName + '</a><cc>' +
            ...
            //             html += '<li><a href="#" class="one">' + data.aaData[1][j].meterialTypeName + '</a><cc>' +
            ...
            //             //             html += '<li><a>' + data.aaData[2][c].meterialTypeName + '</a><cc><a onclick="make(' + data.aaData[2][c].id + ')">修改本类</a><a onclick="del(' + data.aaData[2][c].id + ')">删除本类</a></cc></li>';
            //             //         }
            //             //     }
            //             //     html += '</ul>'
            //             // }
